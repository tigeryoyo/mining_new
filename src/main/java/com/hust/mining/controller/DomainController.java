...
public class DomainController {
	...
	public Object selectDomainOneById(@RequestParam(value = "uuid", required = true) String uuid,HttpServletRequest request){
	...
	public Object deleteDomainOne(@RequestParam(value = "uuid", required = true) String uuid,HttpServletRequest request){
	...
	public Object deleteDomainTwo(@RequestParam(value = "uuid", required = true) String uuid,HttpServletRequest request){
